<template>
  <div class="base-time">
    <div class="time-picker">
      ...
      <el-date-picker v-model="pickerModel" size="small" value-format="YYYY-MM-DD" format="YYYY-MM-DD" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" v-bind="paramsItem.props" />
